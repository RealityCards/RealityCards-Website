export const faqs = [
  ...
  {
    header: 'What is the Leaderboard?',
    body:
  ...
  },
  {
    ...
    body: '<p>Just click your address on the top right.</p>',
  },
  {
  ...
  {
    header: 'What happens to the NFTs after the end of the event?',
    body:
  ...
  },
  {
    ...
    body: '<p>It does not make any difference.</p>',
  },
  {
  ...
  },
  {
    ...
    body: '<p>The code is currently undergoing multiple audits.</p>',
  },
  {
  ...
  },
  {
    ...
    body:
      "<p>They are not yet available to the public and cannot be bought at this time. We do not yet have an ETA for liquidity mining. To keep up to date with developments, please join our <a href='https://realitycards.io/discord' target='_blank'>discord group</a>.</p>",
  },
  {
    header:
  ...
  },
  {
    ...
    body:
      "<p>Please join our <a href='https://realitycards.io/discord' target='_blank'>discord group</a> and ask your question there.</p>",
  },
];
