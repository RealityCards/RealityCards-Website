export const faqs = [
    {
      ...
      body:
        "<p>It is a prediction market focused on offering a best-in-class User Experience. The project has developed following a rapidly iterating process based on user feedback.<br><br>It is completely different from existing prediction markets (Augur, Gnosis Sight/Omen, Flux etc.) in that instead of betting on an outcome, you <i>own</i> it. Concepts such as shares, bids, asks do not exist- even 'odds' are abstracted away, replaced by a 'daily rental price'.<br><br>Thus, as a pragmatic new solution to an existing problem, Reality Cards plans to become the betting platform of choice of retail non tech-savvy users.</p>",
    },
    {
    ...
    {
    header:
        "How do Estimated Winnings work?",
    body:
    ...
    {
      header: "Does it make any difference if I own the Card at the end of the event/if I am the last owner of the Card?",
      body:
    ...
    },
    {
      ...
      body:
        "<p>Yes, there are three:<ol><li>The minimum daily rental price is 0.01 DAI.</li><li>To take a Card off an existing owner, you must set a daily rental price at least 10% above what the current owner is paying.</li><li>You must deposit enough DAI to fund at least one hour’s rent (i.e. the daily rental price you have chosen, divided by 24).</li></ol></p>",
    },
    {
        header: "I can't figure out what the optimum strategy is? When is it in my interests to rent a token, if I think there is an X% chance of an outcome occurring?",
        body:
        "<p>Please see <a href='https://ethresear.ch/t/what-is-the-optimum-strategy-when-using-a-harberger-tax-prediction-market/7194' target='_blank'>here</a>.</p>",
      },
    {
      header:
    ...
    },
    {
      ...
      body:
        "<p>Not at this time- 100% of the rent is returned to users in the form of winnings. Fees will be incorporated (as a % on rental payments) at a future date. Fees will be shared between Reality Cards token (RC) holders and market creators (when this feature is added) to incentivise the creation of useful markets, and their promotion. In addition, a small allocation of fees will accrue to a Rewards Pool which will be used to reward users who achieve various goals (for example: the creator of the highest liquidity market each month).</p>",
    },
    {
      header: "How does Reality Cards make money?",
      body: "<p>Reality Cards does not make any money at this time. Ultimately, Reality Cards plans to make money by charging fees as a % of rent. These fees will be shared between Reality Cards token (RC) holders and market creators.</p>",
    },
    {
    ...
    },
    {
      ...
      body:
        "<p>Yes, there will be a Reality Cards ERC-20 token (RC), however it has not yet been implemented. The token will give users the opportunity to share ownership of the platform (and receive various benefits for doing so), incentivising both the use of the platform and ownership of the token.<br><br>Tokens will be partly distributed via 'liquidity mining', whereby users of the protocol will automatically be granted RC tokens, in proportion to rent paid.</p>",
    },
    {
      header: "What is the Reality Cards token (RC) used for?",
      body:
        "<p>We are still working on the specifcs of the Reality Cards (RC) token. Our thinking at this time is that the token will have the following uses:<ul><li>Final layer of outcome resolution if there are continued disputes</li><li>Required to create markets (helps to limit spam, duplicate markets etc.)</li><li>Fees will accrue to RC holders (less the share given to market creators and the Rewards Pool)</li><li>Project governance</li><li>Incentivise platform use via liquidity mining</li></ul></br>In addition, market creators will have the option of creating markets denominated in RC, for a greater share of the fees. It will not be necessary to own tokens to interact with existing markets, to rent tokens, etc.</p>",
    },
    {
        header: "What is the allocation of the Reality Cards token (RC)?",
        body:
          "<p>Token allocation:<ol><li>Founders/advisors: 25%</li><li>Project Treasury: 25%</li><li>Private & public sales and/or liquidity mining: 50%</li></ol>Tokens allocated to the Project Treasury can only be used with majority approval of existing token holders. There is also a two year vesting period, from the date of the public sale (or start of liquidity mining), for founders, advisors, and seed round investors (25% vesting each six months).<br><br>'Liquidity mining' refers to the allocation of RC tokens to everyone who rents tokens, a growth model used to great success by existing defi platforms such as Balancer and Compound.</p>",
      },
    {
      header: "How can I buy the Reality Cards token (RC)? When will liquidity mining begin?",
      body:
        "<p>They are not yet available to the public and cannot be bought at this time. We do not yet have an ETA for liquidity mining. To keep up to date with developments, please join our <a href='https://t.me/realitycards' target='_blank'>telegram group</a>.</p>",
    },
    {
      header: "I am an angel investor and/or I represent a fund. How can I get in touch?",
      body:
    ...
    },
    {
      ...
      body:
        "<p>Please join our <a href='https://t.me/realitycards' target='_blank'>telegram group</a> and ask your question there.</p>",
    },
  ];
